...
If fuel or mileage remains unavailable, the supported next option is an external Bluetooth Low Energy OBD-II adapter with a separate, carefully permissioned phone-side data source. OBD integration is not included in v0.10.0.
